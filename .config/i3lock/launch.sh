...
i3lock \
  ...
  --pass-screen-keys \
  --pass-volume-keys \
  --time-font="Arimo Nerd Font Propo" \
  --date-font="Arimo Nerd Font Propo" \
  --layout-font="Arimo Nerd Font Propo" \
  --verif-font="Arimo Nerd Font Propo" \
  --wrong-font="Arimo Nerd Font Propo"
